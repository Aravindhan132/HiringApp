package com.example.anki.hiringapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class ListViewAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            style.setText(s.technologyExists);
            //chkTechExists.setEnabled(true);

            if(s.getImageURL() != null && s.getImageURL().length()>0)
            {
                Picasso.get().load(s.getImageURL()).placeholder(R.drawable.ic_launcher_background).into(spacecraftImageView);
            }else {
    ...
    public class JSONDownloader {
        ...
        //SAVE/RETRIEVE URLS
        private static final String JSON_DATA_URL="https://raw.githubusercontent.com/Aravindhan132/Guvi/master/sample.json";
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            try
                            {
                                for(int i=0;i<response.length();i++)
                                {
                                    ...
                                    String propellant=jo.getString("email");
                                    String techExists=jo.getString("email");
                                    String imageURL="https://media.istockphoto.com/photos/glass-of-light-beer-picture-id509685858?k=6&m=509685858&s=612x612&w=0&h=PufwDx7yr1KYWXE2as3XCVtG0ZDdiw8byMfe0HJpSSg=";
